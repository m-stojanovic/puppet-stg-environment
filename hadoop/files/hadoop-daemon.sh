...
# some variables
#fix naming of log file written
export HADOOP_LOGFILE=$HADOOP_IDENT_STRING-$command-$HOSTNAME.log

#fix root logger to use rolling file appender like hdfs and hbase 
#export HADOOP_ROOT_LOGGER="INFO,DRFA"
export HADOOP_ROOT_LOGGER="INFO,RFA"

export HADOOP_SECURITY_LOGGER="INFO,DRFAS"
export _HADOOP_DAEMON_OUT=$HADOOP_LOG_DIR/$HADOOP_IDENT_STRING-$command-$HOSTNAME.out
